...
def print_cluster_diagram(services: list[SparkService]) -> None:
  ...
  │   └─────────────────────┘                             │""")
        ...
        print("  └─────────────────────────────────────────────────────────┘")
        print("                              │")
        print("                              │ Volume mount: ./work:/opt/spark/apps")
        print("                              │")
        print("  ┌─────────────────────────────────────────────────────────┐")
        print("  │                      Host Machine                        │")
        print("  │                                                          │")
        print("  │   ./work/word_count.py  ────►  /opt/spark/apps/word_count.py")
        print("  │                                                          │")
        print("  └──────────────────────────────────────────────────────────┘")
...
def main():
    ...
    print("   docker exec -it spark-master /opt/spark/bin/spark-submit /opt/spark/apps/word_count.py")
    print()
    ...
    print("   3. Shared volume ./work:/opt/spark/apps enables code sharing")
